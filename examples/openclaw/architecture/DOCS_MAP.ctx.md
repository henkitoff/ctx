...
**Key modules:** [[modules/agents.ctx|agents]] · [[modules/gateway.ctx|gateway]] · [[modules/plugins.ctx|plugins]] · [[modules/config.ctx|config]] · [[modules/channels.ctx|channels]] · [[modules/memory.ctx|memory]] · [[modules/tasks.ctx|tasks]] · [[modules/cli.ctx|cli]]

**Architecture docs:** [[architecture/AGENT_RUNTIME.ctx|AGENT_RUNTIME]] · [[architecture/MULTI_AGENT.ctx|MULTI_AGENT]] · [[architecture/MESSAGE_FLOW.ctx|MESSAGE_FLOW]] · [[architecture/GATEWAY_PROTOCOL.ctx|GATEWAY_PROTOCOL]] · [[architecture/PLUGIN_SYSTEM.ctx|PLUGIN_SYSTEM]] · [[architecture/AGENT_PIPELINE.ctx|AGENT_PIPELINE]] · [[architecture/LOCAL_INFERENCE.ctx|LOCAL_INFERENCE]] · [[architecture/SANDBOX.ctx|SANDBOX]]
