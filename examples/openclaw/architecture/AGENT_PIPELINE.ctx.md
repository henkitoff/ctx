...
## Model Selection Cascade  <!-- all-tiers -->
...
[[modules/config.ctx|config]] → [[modules/agents.ctx|agents]] → [[modules/acp.ctx|acp]] → (Pi agent-core) → [[modules/gateway.ctx|gateway]] protocol

- [[modules/plugins.ctx|plugins]] — skill loading and provider resolution
- [[modules/sessions.ctx|sessions]] — session key and transcript
