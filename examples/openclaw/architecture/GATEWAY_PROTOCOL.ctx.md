...
## Adding a New RPC Method  <!-- sonnet+ -->
...
- [[modules/gateway.ctx|gateway]] — implements the RPC server and protocol schema
- [[modules/cli.ctx|cli]] — primary RPC client (all CLI commands go through gateway RPC)
- [[modules/acp.ctx|acp]] — agent events delivered via gateway protocol to clients
- [[modules/channels.ctx|channels]] — `ChannelsStatus` RPC method
